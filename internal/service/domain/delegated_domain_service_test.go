...
func TestDelegatedDomainService_CreateDomain(t *testing.T) {
	coreTesting.RunTestCaseWithDB(t, func(tb coreTesting.TB, ctx coreTesting.TestContext) {
		...
		wd, err := svc.CreateDomain(context.Background(), "icann", "example.com", website.ID, 1, true, true, nil, false)
...
func TestDelegatedDomainService_CreateDomain_NotifyEvenWhenPrimarySet(t *testing.T) {
	coreTesting.RunTestCaseWithDB(t, func(tb coreTesting.TB, ctx coreTesting.TestContext) {
		...
		wd, err := svc.CreateDomain(context.Background(), "icann", "alt-example.com", website.ID, 1, true, true, nil, false)
		assert.NoError(tb, err)
		assert.NotNil(tb, wd)
...
func TestDelegatedDomainService_CreateDomain_SelfHosted(t *testing.T) {
	...
	coreTesting.RunTestCaseWithDB(t, func(tb coreTesting.TB, ctx coreTesting.TestContext) {
		...
		wd, err := svc.CreateDomain(context.Background(), "icann", "example.com", website.ID, 1, false, true, nil, false)
		assert.NoError(tb, err)
		assert.NotNil(tb, wd)
...
func TestDelegatedDomainService_CreateDomain_DuplicateKey(t *testing.T) {
	...
	coreTesting.RunTestCaseWithDB(t, func(tb coreTesting.TB, ctx coreTesting.TestContext) {
		...
		_, err := svc.CreateDomain(context.Background(), "icann", "example.com", website.ID, 1, false, true, nil, false)
...
func TestDelegatedDomainService_CreateDomain_SelfHostedDANEFailurePurgesBinding(t *testing.T) {
	coreTesting.RunTestCaseWithDB(t, func(tb coreTesting.TB, ctx coreTesting.TestContext) {
		...
		_, err := svc.CreateDomain(context.Background(), "hns", "example", website.ID, 1, false, false, nil, false)
		require.Error(tb, err)
...
func TestDelegatedDomainService_CreateDomain_SubdomainReusesParentZone(t *testing.T) {
	...
	coreTesting.RunTestCaseWithDB(t, func(tb coreTesting.TB, ctx coreTesting.TestContext) {
		...
		wd, err := svc.CreateDomain(context.Background(), "icann", "docs.example.com", website.ID, 1, true, true, nil, false)
		assert.NoError(tb, err)
		assert.NotNil(tb, wd)
...
func TestDelegatedDomainService_CreateDomain_SubdomainForeignParentRejected(t *testing.T) {
	...
	coreTesting.RunTestCaseWithDB(t, func(tb coreTesting.TB, ctx coreTesting.TestContext) {
		...
		_, err := svc.CreateDomain(context.Background(), "icann", "docs.example.com", website.ID, 1, true, false, nil, false)
		require.Error(tb, err)
...
func TestDelegatedDomainService_CreateDomain_UnsupportedNamespace(t *testing.T) {
	coreTesting.RunTestCaseWithDB(t, func(tb coreTesting.TB, ctx coreTesting.TestContext) {
		...
		_, err := svc.CreateDomain(context.Background(), "ens", "example.eth", 1, 1, true, false, nil, false)
		assert.Error(tb, err)
