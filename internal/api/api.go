...
See also:.*`),
				...
				router.WithErrorResponses(router.DefineSwaggerErrorResponses(
					router.DefineSwaggerErrorResponse(http.StatusBadRequest, "Invalid request body or validation error"),
					router.DefineSwaggerErrorResponse(http.StatusGone, "Website target content is broken"),
...
See also:.*`),
				...
				router.WithErrorResponses(router.DefineSwaggerErrorResponses(
					router.DefineSwaggerErrorResponse(http.StatusBadRequest, "Invalid website ID format"),
...
See also:.*`),
				...
				router.WithErrorResponses(router.DefineSwaggerErrorResponses(
					router.DefineSwaggerErrorResponse(http.StatusBadRequest, "Invalid domain format"),
					router.DefineSwaggerErrorResponse(http.StatusNotFound, "Website not found"),
					router.DefineSwaggerErrorResponse(http.StatusInternalServerError, "Internal server error occurred"),
