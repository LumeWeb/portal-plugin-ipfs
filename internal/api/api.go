...
See also:.*`),
		...
		router.NewRoute(http.MethodGet, "/platform-domains/availability", a.checkPlatformDomainAvailability,
			router.WithAccess(core.ACCESS_USER_ROLE),
			router.WithSwagger(
				...
				router.WithTags("Websites", "Domains"),
				router.WithQueryParam("label", "Candidate subdomain label", true),
