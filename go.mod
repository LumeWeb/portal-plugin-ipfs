...
require (
	...
	github.com/ipld/go-ipld-prime/storage/bsadapter v0.0.0-20260622045132-9ea56ac1215d
	...
	go.lumeweb.com/web/go/portal-plugin-ipfs v0.0.0-20260630005403-64e5b3d264a9
