...
require (
	...
	go.lumeweb.com/web/go/portal-plugin-ipfs v0.0.0-20260526172636-658cb25ff6e4
...
require (
	...
	go.lumeweb.com/web/go/portal-plugin-core v0.0.0-20260526172636-658cb25ff6e4 // indirect
