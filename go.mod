...
require (
	...
	github.com/ipld/go-ipld-prime/storage/bsadapter v0.0.0-20260601093823-bc7bf1be8a05
	...
	go.lumeweb.com/web/go/portal-plugin-ipfs v0.0.0-20260531153300-86c2997e1203
