...
require (
	...
	github.com/ipld/go-ipld-prime/storage/bsadapter v0.0.0-20260713072404-77ddb83b346c
	...
	go.lumeweb.com/portal v0.5.2-0.20260720203633-7c41c0241aba
	go.lumeweb.com/portal-middleware v0.3.7
	go.lumeweb.com/portal-plugin-core v0.1.0
	go.lumeweb.com/portal-plugin-dashboard v0.3.1-0.20260718154130-077206a2fc1c
	go.lumeweb.com/portal-plugin-quota v0.1.0
	go.lumeweb.com/portal-router v0.7.6
	go.lumeweb.com/queryutil v0.3.17
	go.lumeweb.com/web/go/portal-plugin-ipfs v0.0.0-20260721121637-0d29a8ce2730
